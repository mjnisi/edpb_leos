...
abstract class MemorandumScreenImpl extends VerticalLayout implements MemorandumScreen {
    ...
    void init() {
        ...
        refreshNoteButton();
        refreshButton();
        searchDelegate = new SearchDelegate(searchButton, memorandumDoc, messageHelper, eventBus, memorandumContent);
    ...
    public void initAnnotations(DocumentVO memorandum, String proposalRef, String connectedEntity) {
        new AnnotateExtension<>(memorandumContent, eventBus, cfgHelper, null, AnnotateExtension.OperationMode.NORMAL, false, true, proposalRef, connectedEntity);
    }
