...
public class ProposalDocumentContentServiceImpl extends DocumentContentServiceImpl {
    ...
    public ProposalDocumentContentServiceImpl(TransformationService transformationService,
                                              ...
                                              MemorandumService memorandumService, XmlContentProcessor xmlContentProcessor) {
        super(transformationService, compareService, annexService, billService, memorandumService, null, xmlContentProcessor);
    }
    ...
    public String toEditableContent(XmlDocument xmlDocument, String contextPath, SecurityContext securityContext) {
        ...
        return getEditableXml(xmlDocument, contextPath, securityContext);
    }
