...
public class AnnexServiceImpl implements AnnexService {
    ...
    public static final String ANNEX_DOC_EXTENSION = ".xml";
    ...
    public Annex createAnnex(String templateId, String path, AnnexMetadata metadata, String actionMessage, byte[] content) {
        ...
        final String fileName = ref + ANNEX_DOC_EXTENSION;
        metadata = metadata.withRef(ref);
        Annex annex = annexRepository.createAnnex(templateId, path, fileName, metadata);
