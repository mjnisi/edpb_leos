...
public class ProposalServiceImpl implements ProposalService {
    ...
    public Proposal createClonedProposalFromContent(String path, ProposalMetadata metadata,
        ...
        String name = generateProposalName();
        metadata = metadata.withRef(name.replaceAll(PROPOSAL_DOC_EXTENSION + "$", ""));//FIXME: a better scheme needs to be devised
        return proposalRepository.createClonedProposalFromContent(path, name, metadata, cloneProposalMetadataVO,
    ...
    public Proposal addComponent(Proposal proposal, String docId, LeosCategory leosCategory){
        ...
        byte[] updatedBytes = xmlNodeProcessor.setValuesInXml(xmlBytes,
                keyValueMap,
                xmlNodeConfigHelper.getProposalComponentsConfig(leosCategory, "xml:id"));
        updatedBytes = xmlContentProcessor.doXMLPostProcessing(updatedBytes);
