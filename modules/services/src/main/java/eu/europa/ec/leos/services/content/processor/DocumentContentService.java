...
public interface DocumentContentService {
    ...
    XmlDocument getOriginalAnnex(XmlDocument xmlDocument);

    XmlDocument getOriginalExplanatory(XmlDocument xmlDocument);
    
    XmlDocument getOriginalBill(XmlDocument xmlDocument);

    XmlDocument getOriginalMemorandum(XmlDocument xmlDocument);
    ...
    void useCloneProposalMetadataVO(CloneProposalMetadataVO cloneProposalMetadataVO);
}
