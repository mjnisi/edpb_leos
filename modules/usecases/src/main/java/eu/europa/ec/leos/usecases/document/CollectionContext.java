...
public abstract class CollectionContext {
    ...
    public void executeImportProposal() {
        ...
        createDefaultExplanatories(leosPackage, metadata);
    ...
    protected abstract void createDefaultExplanatories(LeosPackage leosPackage, ProposalMetadata metadata);
    ...
    public abstract void useExplanatory(String explId);
