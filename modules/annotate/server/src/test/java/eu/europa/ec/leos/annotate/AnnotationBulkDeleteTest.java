...
public class AnnotationBulkDeleteTest {
    ...
    public void testBulkDeleteAnnotations() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annot2.getId(), AnnotationStatus.DELETED, theUser.getId());
        TestHelper.assertHasStatus(annotRepos, annot3.getId(), AnnotationStatus.NORMAL, null);
    }
    ...
    public void testBulkDeleteAnnotations_DeleteRootBeforeReply() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.DELETED, theUser.getId());
        TestHelper.assertHasStatus(annotRepos, annotReply.getId(), AnnotationStatus.DELETED, theUser.getId());
        TestHelper.assertHasStatus(annotRepos, annotReplyReply.getId(), AnnotationStatus.DELETED, theUser.getId());
    }
    ...
    public void testBulkDeleteAnnotations_NoneFound() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annot2.getId(), AnnotationStatus.NORMAL, null);
    }
