...
public class AnnotationAnonymisationTest {
    ...
    public void cleanDatabaseBeforeTests() {
        ...
        Mockito.when(userService.getUserDetailsFromUserRepo(Mockito.anyString(), Mockito.anyString())).thenReturn(details);
    ...
    public void testAnonymisationIscAnnotationSentLeosModels_noUserDetails() {
        ...
        Mockito.when(userService.getUserDetailsFromUserRepo(Mockito.anyString(), Mockito.anyString())).thenReturn(null);
