...
public class AnnotationSaveTest {
    ...
    public void testCreatingAnnotationsWithDifferentMetadata() throws Exception {
        ...
        final long firstMetaId = annotRepos.findById(annot.getId()).getMetadata().getId();
        final long secondMetaId = annotRepos.findById(annotSecond.getId()).getMetadata().getId();
