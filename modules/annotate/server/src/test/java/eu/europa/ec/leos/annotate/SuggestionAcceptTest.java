...
public class SuggestionAcceptTest {
    ...
    public void testAcceptSimpleSuggestion() throws Exception {
        ...
        Assert.assertEquals(1, documentRepos.count());
        Assert.assertEquals(1, tagRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.ACCEPTED, theUser.getId());
    ...
    public void testAcceptSimpleSuggestionWithReply() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.ACCEPTED, theUser.getId());
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.ACCEPTED, theUser.getId());
    }
    ...
    public void testAcceptSimpleSuggestionWithDeletedReply() throws Exception {
        ...
        final Annotation savedReply = annotRepos.findById(reply.getId());
        ...
        Assert.assertEquals(2, annotRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.ACCEPTED, theUser.getId());
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.DELETED, null); // null since we manually manipulated status; AnnotationService
                                                                                                 // was not involved
    }
