...
public class AnnotationDeleteTest {
    ...
    public void testDeleteSimpleAnnotation() throws Exception {
        ...
        Assert.assertEquals(1, documentRepos.count());
        Assert.assertEquals(2, tagRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.DELETED, theUser.getId());

        // check that the annotation status would be reported correctly in JSON format
        final Annotation annotRetrieved = annotRepos.findById(annot.getId());
    ...
    public void testDeleteSimpleAnnotationOfOtherUser() throws Exception {
        ...
        Assert.assertEquals(1, documentRepos.count());
        Assert.assertEquals(2, tagRepos.count());
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.DELETED, otherUser.getId());
    }
    ...
    public void testSentDeleteSentAnnotationFromIsc() throws Exception {
        ...
        final Annotation readAnnot = annotRepos.findById(annot.getId());
    ...
    public void testSentDeleteSentAnnotationFromIscTwiceDoesNotToggleStatus() throws Exception {
        ...
        // verify: annotation has the "sentDeleted" flag
        Annotation readAnnot = annotRepos.findById(annot.getId());
        Assert.assertNotNull(readAnnot);
        Assert.assertTrue(readAnnot.isSentDeleted());
        ...
        readAnnot = annotRepos.findById(annot.getId());
        Assert.assertTrue(readAnnot.isSentDeleted());
    }
    ...
    public void testDeleteSimpleReplyOfOtherUser() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annot.getId(), AnnotationStatus.NORMAL, null);
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.DELETED, otherUser.getId());
    }
    ...
    public void testSentDeleteSentReplyFromIsc() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.NORMAL, null);
        Assert.assertTrue(annotRepos.findById(reply.getId()).isSentDeleted());
    }
    ...
    public void testDeleteSentReplyFromLeos() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, reply.getId(), AnnotationStatus.DELETED, userInfo.getUser().getId());
    }
    ...
    public void testDeleteReplyWithoutSubreply() throws Exception {
        ...
        Assert.assertEquals(1, documentRepos.count());
        TestHelper.assertHasStatus(annotRepos, annotSecondReplyId, AnnotationStatus.DELETED, theUser.getId());
    ...
    public void testDeleteReplyHavingSubreply() throws Exception {
        ...
        TestHelper.assertHasStatus(annotRepos, annotFirstReplyId, AnnotationStatus.DELETED, theUser.getId());
