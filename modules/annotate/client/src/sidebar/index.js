...
module.exports = angular.module('h', [
  ...
  .component('ckeditorMarkdown', require('../../leos/sidebar/components/leos-ckeditor-markdown')) // LEOS Change
  ...
  .component('leosSelectionPane', require('../../leos/sidebar/components/leos-selection-pane')) // LEOS Change
  ...
  .service('annotationMapper', isLeosDocument ? require('../../leos/sidebar/services/leos-annotation-mapper') : require('./services/annotation-mapper'))
  .service('api', isLeosDocument ? require('../../leos/sidebar/services/leos-api') : require('./services/api'))
  ...
  .service('suggestionMerger', require('../../leos/sidebar/services/leos-suggestion-merger'))
