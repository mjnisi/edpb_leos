...
hypothesis_adder.Adder.prototype.handleCommentCommand = function(event) {
...
hypothesis_adder.Adder.prototype.disableAnnotations = function() {
  this.disableCommentButton();
  this.disableSuggestionButton();
  this.disableHighlightButton();
};

hypothesis_adder.Adder.prototype.enableAnnotations = function() {
  this.enableCommentButton();
  this.enableSuggestionButton();
  this.enableHighlightButton();
};

hypothesis_adder.Adder.prototype.disableCommentButton = function() {
...
hypothesis_adder.Adder.prototype.enableCommentButton = function() {
  let button = this.element.querySelector(COMMENT_BTN_SELECTOR);
  if (button) {
...
hypothesis_adder.Adder.prototype.disableHighlightButton = function() {
...
hypothesis_adder.Adder.prototype.enableHighlightButton = function() {
  let button = this.element.querySelector(HIGHLIGHT_BTN_SELECTOR);
  if (button) {
