...
var createCkEditorFilesTask = require('./scripts/gulp/ckeditor');
...
createCkEditorFilesTask('copy-ckeditor4', cfg.dest.base);

// Builds the bundles containing vendor JS code
gulp.task('build-vendor-js', ['copy-ckeditor4'], function () {
  var finished = [];
