                                    ...
                                    function() {
                                        ...
                                        describe("Test akn ordered list.", function() {
                                            describe("Expects to transform akn ordered list back and forth correctly.", function() {
                                                ...
                                                var htmlFragmentInHtml = '<ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-num="1.">content 1</li></ol>';
                                                expectFragmentToBeTransformedCorrectly(aknFragmentInHtml, htmlFragmentInHtml, allConfigs);
                                            });
                                            describe("Expects to transform akn ordered list with alinea back and forth correctly.", function() {
                                                ...
                                                var htmlFragmentInHtml = '<ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-num="1."><p data-akn-element="alinea">content 1</p><ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-num="11.">nested content 1</li></ol></li></ol>';
                                                expectFragmentToBeTransformedCorrectly(aknFragmentInHtml, htmlFragmentInHtml, allConfigs);
                                            });
                                        });
                                    ...
                                    function() {
                                        describe(
                                                ...
                                                function() {
                                                    ...
                                                    var htmlFragmentInHtml = '<li id="art_n1__para_1" data-akn-name="aknNumberedParagraph" data-akn-element="paragraph" data-akn-num="1."><p data-akn-element="subparagraph">Member States<em><strong> shall bring i</strong></em>nto force the laws...</p><p data-akn-element="subparagraph">When Member States adopt those provisions...</p><ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-num="(a)"><p data-akn-element="alinea">fdasfdsafsdafdsafsdafds</p><ol data-akn-name="aknOrderedList"><li data-akn-element="point" data-akn-num="(a)">fdsafsdafdsa</li></ol></li></ol></li>';
