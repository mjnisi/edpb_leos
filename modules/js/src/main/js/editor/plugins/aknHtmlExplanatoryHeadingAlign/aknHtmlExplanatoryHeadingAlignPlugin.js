...
define(function aknHtmlExplanatoryHeadingAlignPluginModule(require) {
    ...
    var pluginDefinition = {
        ...
        icons: 'justifyblock,justifycenter,justifyright', // %REMOVE_LINE_CORE%
        ...
        init: function(editor) {
            ...
            var justifyCommand = {
                ...
                refresh: function(editor, path) {
                    ...
                    if (path.lastElement.getAttribute(DATA_AKN_NAME) && path.lastElement.getAttribute(DATA_AKN_NAME) === CROSS_HEADING) {
            ...
            if (editor.ui.addButton) {
                ...
                editor.ui.addButton('JustifyBlock', {
                    label: editor.lang.aknHtmlExplanatoryHeadingAlign.block,
