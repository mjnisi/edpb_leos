                        ...
                        from: {
                            action: function action(element) {
                                ...
                                if (rootElementForToRegExp.test(path)) {
                                    ...
                                    if((typeof element.attributes[DATA_AKN_CROSS_HEADING_TYPE] !== 'undefined') && element.attributes[DATA_AKN_CROSS_HEADING_TYPE] === 'list'){
                                        this.mapToProducts(element, [{
                                            ...
                                            toPath: [DATA_LIST_CROSS_HEADING_PATH, "text"].join("/"),
                                            toChild: "text",
                                            toChildTextValue: element.value
                                        }]);
