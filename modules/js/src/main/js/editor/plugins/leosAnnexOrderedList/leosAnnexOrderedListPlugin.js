...
define(function leosAnnexOrderedListPluginModule(require) {
    ...
    function _onEnterKey(context) {
        ...
        if ((leosKeyHandler.isContentEmptyTextNode(selectedElement) && leosPluginUtils.isSelectionInFirstLevelList(selectedElement))
            || leosPluginUtils.isAnnexList(selectedElement.getAscendant('ol', true))) {
    ...
    function _resetDataNumOnIndent(event) {
        ...
        while ((range = iterator.getNextRange())) {
            if (range.startContainer) {
                ...
                if (range.startContainer.type === CKEDITOR.NODE_TEXT && startNode.getParent().getName() === 'ol' && startNode.getParent().getAttribute('data-akn-name') === 'aknAnnexList') {
            ...
            if (range.endContainer) {
                ...
                if (range.endContainer.type === CKEDITOR.NODE_TEXT && endNode.getParent().getName() === 'ol' && endNode.getParent().getAttribute('data-akn-name') === 'aknAnnexList') {
