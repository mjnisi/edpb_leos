...
define(function annotateExtensionModule(require) {
    ...
    function _initAnnotateApplication(connector) {
        ...
        _addHostConfig(document, connector.getState().annotationContainer,
                                ...
                                connector.getState().annotationPopupDefaultStatus,
                                connector.getState().proposalRef,
                                connector.getState().connectedEntity);
    ...
    function _connectorEditorListener(event) {
        ...
        if (event.editor && event.editor.element && event.editor.element.getChildCount() > 0) {
            ...
            eventFilterHighlights.filterParentElementId = editor.element.getLast().getId();
            var annotationContainerElt = document.querySelector(connector.getState().annotationContainer);
            if (annotationContainerElt) {
    ...
    function _addHostConfig(doc, annotationContainer, authority, anotHost, anotClient, oauthClientId, operationMode, showStatusFilter, showGuideLinesButton, annotationPopupDefaultStatus, proposalRef, connectedEntity) {
        var script = doc.createElement('script');
        ...
        script.innerHTML = `{
                                ...
                                "annotationPopupDefaultStatus" : "${annotationPopupDefaultStatus}",
                                ...
                                "editableSelector": "[leos\\\\:editable=true],article,heading,recitals,citations,level,paragraph",
